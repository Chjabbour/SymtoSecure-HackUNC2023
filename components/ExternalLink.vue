...
Additional Medical Information:    </p>
  ...
  <li>
    ...
    >
    <div class="flex-shrink-0 flex h-10 w-2 items-center justify-center rounded-lg text-slate-500"></div>
  <div class="w-full flex-grow min-w-0">
    <p class="font-medium text-sm leading-6 text-gray-900" style="overflow-wrap: break-word;">
      {{ label }}
    </p>
  </div>
    </dt>
